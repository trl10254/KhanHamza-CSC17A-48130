...
.NO_PARALLEL:${OBJECTDIR}/Savings\ Account.o
${OBJECTDIR}/Savings\ Account.o: Savings\ Account.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Savings\ Account.o Savings\ Account.cpp
